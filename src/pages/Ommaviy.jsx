...
const Ommaviy = () => {
  ...
  <>
  <div className="hero">
  <div className='border border-gray-300 border-r-4 max-w-full mx-auto xl:max-w-[900px]'>
  <div className='max-w-[500px] mx-auto text-base pt-5 xl:pt-[90px]'>
    <h2 className='mx-auto text-center font-bold text-sm sm:text-sm md:text-md lg:text-lg xl:text-xl pb-5'>
      OMMAVIY OFERTA (O’zbekiston Respublikasi Fuqorolik to’g’risidagi Kodeksning 369-moddasiga ko’ra ushbu ommaviy oferta yuridik shartnoma bilan tenghuquqqa ega bo’lib, “IT-MAKER” MCHJ “100k.uz” Saytining huquqiy jihatlarini o’z ichiga oladi)
    </h2>
    ...
    <br />
    <p className='mb-5 xl:mb-20'>Tovar(tovarlar) Internet do’konlar tomonidan sotuvga qo’yiladigan vaXaridorning buyurtmasiga binoan Sotuvchi tomonidan masofadan turib(distantsion) sotib olinadigan va Xaridorga jo’natiladigan tovarlar</p>
  </div>
</div>
