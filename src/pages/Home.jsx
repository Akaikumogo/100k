...
const Home = () => {
  ...
  <div className="w-full max-w-[1000px] px-5 mx-auto">
    <div className="xl:flex xl:items-center xl:text-xl xl:justify-between lg:items-center lg:flex lg:text-lg lg:justify-between md:items-center md:flex md:text-md md:justify-between sm:text-sm sm:text-center sm:mb-3 text-center">
      <h3 className="xl:text-[30px] xl:font-semibold lg:text-[30px] lg:font-semibold md:text-[30px] md:font-semibold sm:text-[30px] sm:my-5 sm:font-semibold, text-[30px] font-semibold my-5">Ommabop mahsulotlar</h3>
      <Link
        to="/Barchasi"
        className="text-red-700 hover:text-[#E30909] inline-block"
      >
        <button className="px-4 py-3 bg-gradient-to-r text-sm  from-red-400 to-purple-400 text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg">
          Barchasini korish
        </button>
      </Link>
  </div>

    <ul className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-5 mt-3">
      {newProducts &&
